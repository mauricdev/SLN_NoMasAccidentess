<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Webpage_Nma.WebForm1" %>
            ...
            <body class="theme-dark io-dark io-dark-light" data-spy="scroll" data-target="#mainnav" data-offset="80">
                ...
                <header class="site-header is-sticky">
                    ...
                    <div class="navbar navbar-expand-lg is-transparent" id="mainnav">
                        <nav class="container">
                            <a class="navbar-brand animated" data-animate="fadeInDown" data-delay=".65" href="#header">
                                ...
                                <div class="row align-items-center mobile-center">
                                    <div class="col-lg-6 col-md-12 order-lg-first">
                                        <div class="header-txt">
                                            <h1 class="animated" data-animate="fadeInUp" data-delay="1.55">Segurito</h1>
                                            <p class="lead color-secondary animated" data-animate="fadeInUp" data-delay="1.65">Deja la seguridad de tú empresa en nuestras manos</p>
                                            <ul class="btns animated" data-animate="fadeInUp" data-delay="1.75">
                                                <li><a href="#contact" class="btn btn-alt">Contactanos</a></li>
                                            </ul>
                                            <ul class="social">
                                                <li class="animated" data-animate="fadeInUp" data-delay="1.85"><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                                <li class="animated" data-animate="fadeInUp" data-delay="1.9"><a href="#"><em class="fab fa-twitter"></em></a></li>
                                                <li class="animated" data-animate="fadeInUp" data-delay="1.95"><a href="#"><em class="fab fa-youtube"></em></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!-- .col  -->
                                    <div class="col-lg-6 col-md-12 order-first">
                                        <div class="header-image animated" data-animate="fadeInRight" data-delay="1.25">
                                            <img src="images/candado2.png" alt="header">
                                        </div>
                                    </div>
                                    <!-- .col  -->
                                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5 offset-md-1">
                                <div class="res-m-btm animated" data-animate="fadeInUp" data-delay=".1">
                                    <img src="images/seguridad.jpg" alt="graph">
                                </div>
                            </div>
                            <!-- .col  -->
                            <div class="col-md-6 order-md-first order-last">
                                <div class="text-block">
                                    <h2 class="animated" data-animate="fadeInUp" data-delay="0">Nuestra Historia</h2>
                                    <p class="lead animated" data-animate="fadeInUp" data-delay=".1">
                                        Somos un grupo de jovenes profesionales que hicieron una empresa con el fin de realizar 
							un trabajo excepcional en el area de la seguridad, dando garantia de nuestro gran trabajo a un bajo costo
                                    </p>
                                    <a href="https://www.youtube.com/watch?v=V1x5ypaMIBg" class="play-btn video-play animated" data-animate="fadeInUp" data-delay=".2">
                                        <em class="play"><span></span></em>
                                        <span>Mira este video</span>
                                        <span>Acerca de la seguridad en las empresas</span>
                                    </a>
                                </div>
                            </div>
                            <!-- .col  -->
                ...
                <div class="section section-pad no-pb section-bg section-light">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="res-m-btm animated" data-animate="fadeInUp" data-delay=".1">
                                    <img src="images/dinero.jpg" alt="graph">
                                </div>
                            </div>
                            <!-- .col  -->
                            <div class="col-md-6 offset-md-1">
                                <div class="text-block">
                                    <h4 class="animated" data-animate="fadeInUp" data-delay="0">Por qué elegirnos?</h4>
                                    <p class="lead animated" data-animate="fadeInUp" data-delay=".1">Trabajamos con los mas exigentes standars de seguridad que apoyarán a su empresa</p>
                                    <p class="animated" data-animate="fadeInUp" data-delay=".2">Realizamos prevencion de riegos a un precio razonable para que su empresa pueda asegurar su seguridad. </p>
                                    <p class="animated" data-animate="fadeInUp" data-delay=".3">Cumplimos estrictamente todos los procesos necesarios para dar cumplimiento a la normativa vigente, mejorando los ambientes de trabajo, la productividad, contribuyendo a un ahorro económico.  </p>
                                </div>
                            </div>
                            <!-- .col  -->
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                                <div class="section-head">
                                    <h2 class="section-title animated" data-animate="fadeInUp" data-delay="0">Servicios
							<span>SERVICIOS</span>
                                    </h2>
                                    <p class="animated" data-animate="fadeInUp" data-delay=".1">Contrata nuestros servicios que tenemos disponible para tí.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="row event-info">
                                    <div class="col-sm-6">
                                        <div class="event-single-info animated" data-animate="fadeInUp" data-delay="0">
                                            <h6>Plan bronce</h6>
                                            <p>Plan básico que te dará mejores prestaciones para tu empresa</p>
                                        </div>
                                    </div>
                                    <!-- .col  -->
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="event-single-info animated" data-animate="fadeInUp" data-delay=".2">
                                            <h6>Plan plata</h6>
                                            <p>Plan medio que te dará mejores prestaciones para tu empresa</p>
                                        </div>
                                    </div>
                                    <!-- .col  -->
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="event-single-info animated" data-animate="fadeInUp" data-delay=".4">
                                            <h6>Plan oro</h6>
                                            <p>Plan full que te dará mejores prestaciones para tu empresa</p>
                                        </div>
                                    </div>
                                    <!-- .col  -->
                                    <div class="col-sm-6">
                            ...
                            <div class="col-lg-5 offset-lg-1">
                                <div class="countdown-box text-center animated" data-animate="fadeInUp" data-delay=".3">
                                    <div class="token-countdown d-flex align-content-stretch" data-date="2020/04/07"></div>
                                    <a href="#contact" class="btn btn-alt btn-sm">Cotiza con nosotros</a>
                                    <ul class="icon-list">
                                        <li><em class="fab fa-cc-paypal"></em></li>
                                        <li><em class="fab fa-cc-discover"></em></li>
                ...
                <!-- Start Section -->
                <div class="section section-pad section-bg-alt section-light" id="team">
                    <div class="container">
                        <div class="row text-center">
                            <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                                <div class="section-head">
                                    <h2 class="section-title animated" data-animate="fadeInUp" data-delay="0">Nuestro equipo
							<span>Segurito</span>
                                    </h2>
                                    <p class="animated" data-animate="fadeInUp" data-delay="0.1">Conoce al equipo que te ayudará a afrontar tu seguridad.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-circle animated" data-animate="fadeInUp" data-delay=".2">
                                    <div class="team-photo">
                                        <img src="images/jazna.jpg" alt="" />
                                    </div>
                                    <div class="team-info">
                                        <h5 class="team-name">Jazna Mesa Hidalgo </h5>
                                        <span class="team-title">Gerente</span>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-circle animated" data-animate="fadeInUp" data-delay=".3">
                                    <div class="team-photo">
                                        <img src="images/mario.jpg" alt="team">
                                    </div>
                                    <div class="team-info">
                                        <h5 class="team-name">Mario Zapata Sanhueza</h5>
                                        <span class="team-title">Jefe contabilidad</span>
                                        <ul class="team-social">
                                            <li><a href=""><em class="fab fa-facebook-f"></em></a></li>
                                            <li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
                                            <li><a href=""><em class="fab fa-twitter"></em></a></li>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-circle animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="team-photo">
                                        <img src="images/mari.jpg" alt="team">
                                    </div>
                                    <div class="team-info">
                                        <h5 class="team-name">Maricel urzua</h5>
                                        <span class="team-title">Jefe de recursos humanos</span>
                                        <ul class="team-social">
                                            <li><a href=""><em class="fab fa-facebook-f"></em></a></li>
                                            <li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
                                            <li><a href=""><em class="fab fa-twitter"></em></a></li>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="team-circle animated" data-animate="fadeInUp" data-delay=".5">
                                    ...
                                    <div class="team-info">
                                        <h5 class="team-name">Jorge Sanchez</h5>
                                        <span class="team-title">Jefe de desarrollo</span>
                                        <ul class="team-social">
                                            <li><a href=""><em class="fab fa-facebook-f"></em></a></li>
                                            <li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
                                            <li><a href=""><em class="fab fa-twitter"></em></a></li>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-6 offset-md-3">
                        <h4 class="section-title-md animated" data-animate="fadeInUp" data-delay="0">No te pierdas nuestras noticias</h4>
                        <form id="subscribe-form" action="form/subscribe.php" method="post" class="subscription-form inline-form">
                            <input type="text" name="youremail" class="input-round required email" placeholder="Ingresa tu email">
                            <input type="text" class="d-none" name="form-anti-honeypot" value="">
                            <button type="submit" class="btn btn-plane">Subscribete</button>
