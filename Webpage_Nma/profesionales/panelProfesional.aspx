<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="panelProfesional.aspx.cs" Inherits="Webpage_Nma.profesionales.panel" %>
                        ...
                        <div class="d-flex">
                            <div class="user-sidebar">
                                ...
                                <div class="user-box d-none d-lg-block">
                                    ...
                                    <h6 class="user-name"><asp:Label runat ="server" ID="label1"></asp:Label></h6>
                                    <h5 class="user-dropdown-email"><asp:Label runat ="server" ID="label3"></asp:Label></h5>
                                </div>
                                <!-- .user-box -->
                                   ...
                                   <!-- .col -->
                                    ...
                                    <div class="info-card info-card-bordered">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <h4>Gracias por trabajar con nosotros</h4>
                                                <p><asp:Label runat ="server" ID="label4"></asp:Label> ,Queremos darte  las gracias por estar trabajando codo a codo con lo que la empresa solicita.</p>
                                                <p>Te dejamos nuestro contacto para que siempre estemos en linea: Sap@segurito.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- .info-card 
